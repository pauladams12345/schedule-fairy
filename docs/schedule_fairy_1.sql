...
CREATE TABLE `messages` (
  ...
  KEY `Msg_ibfk_1_idx` (`fk_user_id`),
  KEY `Msg_ibfk_2_idx` (`fk_slot_id`),
  CONSTRAINT `Msg_ibfk_1` FOREIGN KEY (`fk_user_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `reserve_slot` (
  ...
  CONSTRAINT `ResSlot_ibfk_1` FOREIGN KEY (`fk_user_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
